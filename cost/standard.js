...
const minOutput = 557413.60;
const maxOutput = 5574136.00;
...
// fs.writeFileSync('./net/cost_standard_finish.json', JSON.stringify(networkState), 'utf-8');
